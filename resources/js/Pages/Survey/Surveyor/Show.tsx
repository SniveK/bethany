...
export default function Show({
    ...
    const submit = () => {
        router.post(route('surveyor.survey.hasil', survey.id), {
            comment: comment,
        });
    };
    ...
    return (
        <AuthenticatedLayout user={auth.user} title={"Survey"}>
            <Head title="Survey" />
            <div className="flex ">
                <Link href={route("surveyor.survey.index")}>
                    <Button>Back</Button>
                </Link>
            </div>
            ...
            {survey.survey ? (
                <Card>
                    <CardHeader>
                        <CardTitle className="text-center">Survey sudah dilakukan</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Textarea value={survey.survey} disabled></Textarea>
                    </CardContent>
                </Card>
            ) : (
                <Card>
